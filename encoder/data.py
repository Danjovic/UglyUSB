...
"""
This module contains a keycode lookup table and a string to hid table
"""
...
keycodes = {
    ...
    ('F11', 'KEY_F11'): [0x44, 0],
    ('F12', 'KEY_F12'): [0x45, 0],
    ('SYSRQ','PRINTSCREEN', 'KEY_SYSRQ'): [0x46, 0],
...
# Dictionary with available characters for String entry and their
# their HID codes values as well as the state of SHIFT for each one
charcodes = {
    # characters generated by a single keypress
    (' '):[0x2C,0], # space
	('a'):[0x04,0],
	('b'):[0x05,0],
	('c'):[0x06,0],
	...
	('.'):[0x37,0],
	('/'):[0x38,0],
    # characters generated by holding SHIFT + key
	('A'):[0x04,1],
	('B'):[0x05,1],
	('C'):[0x06,1],
	('D'):[0x07,1],
